...
```{r}
setwd('/Users/matthewreilly/OneDrive/Practice R/Airline Safety')
...
reactable(fmt_data,
  ...
  add_subtitle("* Includes Airlines Subsidaries", 
               font_style = "italic", 
               font_weight = 'normal',
               font_size = 18) %>%
    add_source("FiveThirtyEight: https://fivethirtyeight.com/features/should-travelers-avoid-flying-airlines-that-have-had-crashes-in-the-past/", font_style = "italic", font_color = "grey")
